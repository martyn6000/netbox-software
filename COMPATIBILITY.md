...
This document tracks the minimum and maximum supported NetBox versions for each release of NetBox Software Plugin.
...
- This plugin requires Python 3.10 or later
