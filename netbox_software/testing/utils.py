"""
Utility functions for testing NetBox Software Plugin.
...
def create_test_user(username: str | None = None, permissions: list[str | None] = None,
    ...
    Example:
        ...
        ...     permissions=['netbox_software.view_netboxsoftware']
        ... )
    """
    if username is None:
...
def post_data(data: dict[str, Any]) -> dict[str, Any]:
    ...
    Example:
        ...
        >>> obj = Netboxsoftware.objects.first()
...
def get_deletable_objects(instances):
    ...
    Example:
        >>> objs = Netboxsoftware.objects.filter(name__startswith='test')
        >>> deletions = get_deletable_objects(objs)
        >>> # deletions = {'Netboxsoftware': 3, 'RelatedModel': 5}
    """
...
def assert_object_changes(test_case, instance, action: str,
    ...
    Example:
        ...
        >>> obj = Netboxsoftware.objects.create(name='Test')
