...
Report bugs at https://github.com/martyn6000/netbox-software/issues.
...
NetBox Software Plugin could always use more documentation, whether as part of the
official NetBox Software Plugin docs, in docstrings, or even on the web in blog posts,
articles, and such.

### Submit Feedback

The best way to send feedback is to file an issue at https://github.com/martyn6000/netbox-software/issues.
...
Ready to contribute? Here's how to set up `netbox-software` for local development.

1. Fork the `netbox-software` repo on GitHub.
2. Clone your fork locally

    ```
    $ git clone git@github.com:your_name_here/netbox-software.git
    ```
...
3. The pull request should work for Python 3.12, 3.13, and 3.14. Check
   https://github.com/martyn6000/netbox-software/actions
