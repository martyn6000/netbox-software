# Testing Guide for NetBox Software Plugin

This guide explains how to write and run tests for NetBox Software Plugin.

## Test Structure

Tests are organized in the `netbox_software/tests/` directory:
...
```python
from netbox_software.testing import PluginTestCase
...
```python
from netbox_software.testing import PluginModelTestCase
...
```python
from netbox_software.testing import PluginAPITestCase

class MyAPITestCase(PluginAPITestCase):
    def setUp(self):
        super().setUp()
        self.list_url_name = 'plugins-api:netbox_software-api:mymodel-list'
        self.detail_url_name = 'plugins-api:netbox_software-api:mymodel-detail'
...
```python
from netbox_software.testing import PluginViewTestCase

class MyViewTestCase(PluginViewTestCase):
    def setUp(self):
        super().setUp()
        self.base_url = 'plugins:netbox_software:mymodel'
...
```python
from netbox_software.testing import PluginGraphQLTestCase
...
The `netbox_software.testing.utils` module provides helpful utilities:

```python
from netbox_software.testing.utils import (
...
user = create_test_user(permissions=['netbox_software.view_netboxsoftware'])
...
python manage.py test netbox_software.tests

# Run specific test file
python manage.py test netbox_software.tests.test_models

# Run specific test class
python manage.py test netbox_software.tests.test_models.NetboxsoftwareTestCase

# Run specific test method
python manage.py test netbox_software.tests.test_models.NetboxsoftwareTestCase.test_create

# Run with verbose output
python manage.py test netbox_software.tests -v 2

# Run in parallel (faster)
python manage.py test netbox_software.tests --parallel

# Keep database between runs (faster during development)
python manage.py test netbox_software.tests --keepdb
```
...
# Run tests
docker-compose exec netbox python manage.py test netbox_software.tests

# Run specific tests
docker-compose exec netbox python manage.py test netbox_software.tests.test_api
...
2. Tests on Python 3.10 through 3.14
...
def test_form_validation(self):
    ...
    url = reverse('netbox_software:mymodel_add')
...
jobs:
  ...
  test:    # Tests on Python 3.10 through 3.14
```
...
**"No module named 'netbox_software'"**
